...
print("API KEY 존재 =", GEMINI_API_KEY is not None)
print("API KEY 길이 =", len(GEMINI_API_KEY) if GEMINI_API_KEY else 0)
print("MODEL 생성 전")
...
if not MOCK_MODE and GEMINI_API_KEY:
    ...
    print("MODEL 생성 =", model is not None)
else:
    model = None
